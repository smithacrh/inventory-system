...
<div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
    <h1 class="text-2xl font-bold mb-6">🚚 Laporan Pengiriman</h1>
            ...
            <tbody>
                <?php if (!empty($report_data)): ?>
                    ...
                    <tr class="border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="border border-gray-300 dark:border-gray-600 px-4 py-2"><?php echo $item->consumer_name; ?></td>
                        ...
                        <td class="border border-gray-300 dark:border-gray-600 px-4 py-2"><?php echo date('d/m/Y H:i', strtotime($item->delivery_date)); ?></td>
